...
public class ValidationAspect {
    ...
    @Before(value = "@annotation(com.mjc.school.service.annotations.NotEmptyParam) " +
            "&& args(id)")
    private void validateNumber(JoinPoint joinPoint, Long id) throws ArgumentNotValidException {
    ...
    @Before(value = "@annotation(com.mjc.school.service.annotations.ValidParam) " +
            ...
            "&& args(newsRequest)")
    private void validateNewsParam(NewsDtoRequest newsRequest) throws ArgumentNotValidException {
        Validator.validateNumber(newsRequest.getId(), NEWS_PARAM);
    ...
    @Before(value = "@annotation(com.mjc.school.service.annotations.ValidParam) " +
            ...
            "&& args(authorRequest)")
    public void validateAuthorParam(AuthorDtoRequest authorRequest) throws ArgumentNotValidException {
        Validator.validateNumber(authorRequest.getId(), AUTHOR_PARAM);
