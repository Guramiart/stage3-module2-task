...
public class Validator {
    ...
    public static void validateNumber(Long number, String param) throws ArgumentNotValidException {
    ...
    public static void validateString(String str, String param, int min, int max) throws ArgumentNotValidException {
        if(str == null) {
            throw new ArgumentNotValidException(String.format(
